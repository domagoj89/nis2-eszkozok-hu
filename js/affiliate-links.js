...
window.addEventListener("load", function () {
  ...
  a.id = "tg-cta";
  a.href = "https://t.me/nis2eszkozok";
  a.target = "_blank";
  a.rel = "noopener";
  a.textContent = "📣 NIS2 frissítések a Telegramon";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!document.getElementById("aff-disclosure")) {
    ...
    d.id = "aff-disclosure";
    d.textContent = "Tájékoztatás: ez az oldal affiliate linkeket tartalmaz. Ha ezeken keresztül vásárol, jutalékot kaphatunk, Önnek többletköltség nélkül.";
